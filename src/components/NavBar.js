  ...
  return (
    ...
    <div className="text-2xl font-signature ml-3 cursor-pointer hover:scale-105 duration-200">
      ...
      { nav && (
              ...
              <li className="py-4 cursor-pointer text-white hover:scale-110 duration-200 font-normal"><a href="/#home">Home</a></li>
              <li className="py-4 cursor-pointer text-white hover:scale-110 duration-200 font-normal"><a href="/#about">About Me</a></li>
              <li className="py-4 cursor-pointer text-white hover:scale-110 duration-200 font-normal"><a href="/#projects">Projects</a></li>
              <li  className="py-4 px-4  cursor-pointer text-white hover:scale-110 duration-200 font-normal bg-green-700 rounded hover:bg-green-800"><a href="/#contact">Contact</a></li>
          </ul>
      )}
